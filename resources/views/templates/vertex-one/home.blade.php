...
@section('content')
                ...
                <div>
                    ...
                    <div class="grid grid-cols-[14rem_1fr] gap-4">
                        <img src="{{ asset('assets/templates/' . $template . '/img/claudio.png') }}"
                            ...
                            alt="">
                        <p class="paragraph-light">
                            Desenvolvedor com mais de 20 anos de experiência, Claudio já trabalhou em diversos segmentos da
                            indústria e comércio, atuando desde o planejamento até a entrega e integração do projeto.
                        </p>
                    </div>
                </div>
                <div>
    ...
    <section class="w-full flex flex-col pt-20 scroll-mt-12" id="services">
        ...
        <div class="w-full h-full flex px-4 md:px-20 lg:px-52">
            ...
            <x-card route="{{ route('services') }}"
                img_path="{{ asset('assets/templates/' . $template . '/img/webstrategy.jpg') }}" title="DESENVOLVIMENTO">
