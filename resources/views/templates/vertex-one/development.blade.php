    ...
    <section class="w-full flex flex-col pt-20">
        ...
        <div class="py-8">
            ...
            <x-p_img img_side="left" :template="$template" img_path="/svg/question_mark.svg" class="bg-vertexBlue text-white">
                Outra grande diferença está na complexidade. Sites podem ter alguma lógica, mas nada comparado a um software
                completo, que geralmente possui diversas lógicas diferentes para cada tipo de funcionalidade.<br><br>
                Por exemplo, ao emitir uma nota fiscal, é necessário um sistema dinâmico que busque os produtos corretos,
                ...
                contas e bancos, cálculo de saldos atualizados e tratamento de diversas regras para garantir que todas as
            ...
            <x-p_img :template="$template" img_path="/svg/computer.svg">
                ...
                Ao contratar a Vertex, você tem acesso não só às nossas habilidades técnicas, mas também às nossas sugestões
